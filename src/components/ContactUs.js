    ...
    <div className='contactus'>
      ...
      <p>We are always happy to assist you in every way we can.</p>
        ...
        <div className="form-group">
          ...
          <textarea id="customerQuery" name="customerQuery" rows="4" placeholder="Enter your query"></textarea>
        </div>
        <button className='btn btn-lg btn-dark btn-outline-light '>Submit</button>
      </form>
    </div>
  );
}
